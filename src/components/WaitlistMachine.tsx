...
export const WaitlistMachine = component$(() => {
  ...
  const submit = $(async () => {
    ...
    try {
      ...
      errorMsg.value = message || 'Something went wrong. Please try again.';
      state.value = 'error';
    }
  });
        ...
        <div class="max-w-2xl mx-auto px-4 text-center">
          <div class="bg-green-50 border border-green-200 rounded-2xl p-8 animate-scale-in">
            ...
            <p class="text-green-700 mb-8">
              Thank you for joining! We'll be in touch within 24 hours to
            ...
            {showCalendly.value && (
              <div class="bg-white rounded-xl p-6 shadow-lg">
                ...
                <p class="text-gray-600 mb-6">
                  Book a 15-minute call to discuss your AI needs and get your
                  custom MVP blueprint.
                </p>
                ...
                <div class="bg-gray-100 rounded-lg p-8 border-2 border-dashed border-gray-300">
                  <div class="text-center">
                    ...
                    <p class="text-gray-600 text-sm mb-4">
                      In production, this would show the embedded Calendly
                      widget
                    </p>
                ...
                <p class="text-xs text-gray-500 mt-4">
                  💡 After booking, you'll receive a Stripe checkout link for
                  our paid MVP Blueprint service
                </p>
              </div>
            )}
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
          <div class="text-center mb-8">
            ...
            <p class="text-gray-600">
              Get exclusive early access and a free consultation with our AI
              experts.
            </p>
          </div>
          ...
          <form preventdefault:submit onSubmit$={submit} class="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onInput$={(e) =>
                  (formData.company = (e.target as HTMLInputElement).value)
                }
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
            ...
            <div>
              ...
              <select
                ...
                value={formData.size}
                onChange$={(e) =>
                  (formData.size = (e.target as HTMLSelectElement).value)
                }
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                required
              >
            ...
            <div>
              ...
              <textarea
                ...
                value={formData.pain}
                onInput$={(e) =>
                  (formData.pain = (e.target as HTMLTextAreaElement).value)
                }
                rows={4}
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"

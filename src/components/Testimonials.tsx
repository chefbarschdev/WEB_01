  ...
  const testimonials: Testimonial[] = [
    {
      ...
      content: "AISOLUTIONS transformed our customer service with their AI chatbot. We saw a 70% reduction in response time and 90% customer satisfaction. The ROI was immediate.",
      avatar: "👩‍💼",
      rating: 5
    },
    {
      ...
      content: "The AI automation solution saved us 40 hours per week on manual processes. What used to take days now happens in minutes. Incredible efficiency gains.",
      avatar: "👨‍💼",
      rating: 5
    },
    {
      ...
      content: "Their AI analytics platform gave us insights we never had before. We increased conversion rates by 45% and reduced customer acquisition costs by 30%.",
      avatar: "👩‍🎨",
      rating: 5
    },
    {
      ...
      title: "CEO",
      company: "StartupX",
      content: "From concept to deployment in just 3 weeks. The team's expertise and speed were phenomenal. Our AI-powered product is now our main revenue driver.",
      avatar: "👨‍💻",
      rating: 5
    },
    {
      ...
      content: "The custom AI model they built for our inventory management reduced waste by 25% and improved forecasting accuracy by 60%. Outstanding results.",
      avatar: "👩‍🔬",
      rating: 5
    }
  ];
          ...
          <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 max-w-4xl mx-auto">
            <div class="text-center">
              ...
              <div class="flex justify-center mb-6">
                {Array.from({ length: testimonials[current.value].rating }).map((_, i) => (
              ...
              <div class="flex items-center justify-center space-x-4">
                ...
                <div class="text-left">
                  ...
                  <div class="text-gray-600">
                    {testimonials[current.value].title} at {testimonials[current.value].company}
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="mt-12">
          ...
          <div class="flex justify-center items-center space-x-8 opacity-60">
            {[
              ...
              <div key={company} class="bg-gray-200 h-12 px-6 rounded flex items-center justify-center">
